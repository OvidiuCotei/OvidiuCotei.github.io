...
// Nr prime cu supraincarcare operatori
...
func ==(lhs: t_set_of_primes, rhs: t_set_of_primes)->Bool{
    return lhs.subset(rhs) && lhs.nr_elemente() == rhs.nr_elemente()  
}
...
var test = teste.sterge
    switch test.rawValue{
        ...
        case "6": // testam intersectie
            ...
            m.intersectie(x)
            m.print_set()
        case "7": // suprareincarc operatorul +=
            let m = t_set_of_primes(7)
            m += 2
            m << 3
            m << 4
        ...
        case "10": // suprareincarc apartine
