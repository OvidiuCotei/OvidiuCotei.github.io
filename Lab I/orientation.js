...
function on_device_motion(e)
{
	...
	document.getElementById("id_rot_x").innerHTML = Mathf.round(Math.atan(acc_x / acc_z) * 180 / Math.PI * 100) / 100;
	document.getElementById("id_rot_y").innerHTML = Mathf.round(Math.atan(acc_y / acc_z) * 180 / Math.PI * 100) / 100;
}